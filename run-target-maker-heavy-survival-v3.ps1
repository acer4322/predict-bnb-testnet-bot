...
try {
    ...
    python .\tools\analyze_target_maker_heavy_survival_v3_1.py `
        --public-dataset $PublicDataset `
    ...
    if ($LASTEXITCODE -ne 0) { throw "V3.1 survival analysis/integrity preflight failed." }
    ...
    Write-Host "V3.1 report: data\research\target_maker_heavy_survival_v3_report.json"
